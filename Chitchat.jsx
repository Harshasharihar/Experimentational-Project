...
export default function UfsPerformanceDetails({
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      role: "assistant",
      text: "Hello! How can I help you with the UFS performance results?",
    },
  ]);
  ...
  const sendChatMessage = () => {
    ...
    // Placeholder response until the chat is connected to a backend.
    setTimeout(() => {
      setChatMessages((previous) => [
        ...previous,
        {
          role: "assistant",
          text: "I can help review the selected UFS performance scenarios and results.",
        },
      ]);
    }, 350);
  };
  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 0.8 }}>
          <IconButton
            ...
            sx={{
              ...
              borderRadius: "7px",
              flexShrink: 0,
              background: drawerOpen ? "rgba(255,255,255,.12)" : "transparent",
      ...
      {/* =====================================================
          RIGHT CHAT DRAWER
          Opens only between the fixed header and footer.
          It does not create a page-level scrollbar.
      ====================================================== */}
      <Drawer
        anchor="right"
        open={drawerOpen}
        ...
        PaperProps={{
          sx: {
            ...
            background: "#FFFFFF",
            boxShadow: "-8px 0 28px rgba(7,27,60,.14)",
            display: "flex",
            flexDirection: "column",
            overflow: "hidden",
          },
      ...
      >
        ...
        <Box
          sx={{
            ...
            alignItems: "center",
            justifyContent: "space-between",
            background: "linear-gradient(135deg,#071B3C 0%,#0B2B58 100%)",
        ...
        <Box
          sx={{
            ...
            background: "#F7F9FC",
            scrollbarWidth: "thin",
            scrollbarColor: "#B6C4D5 transparent",
            "&::-webkit-scrollbar": { width: 7 },
                ...
                <Box
                  sx={{
                    ...
                    borderRadius: isUser
                      ? "10px 10px 3px 10px"
                      : "10px 10px 10px 3px",
                    background: isUser ? theme.blue : "#FFFFFF",
                    color: isUser ? "#FFFFFF" : theme.text,
                    border: isUser
                      ? "none"
                      : `1px solid ${theme.border}`,
                    boxShadow: isUser
                      ? "0 3px 8px rgba(8,127,245,.16)"
                      : "0 2px 6px rgba(7,27,60,.05)",
                  }}
                >
                  <Typography
                    sx={{
        ...
        >
          <Box sx={{ display: "flex", alignItems: "flex-end", gap: 0.8 }}>
            <TextField
              ...
              placeholder="Ask about the performance results..."
              sx={{
